    ...
    <div class="card">
        <div class="card-header">
            <div class="form-horizontal row">
                <div class="col-md-12">
                    <label class="col-form-label">{{ __('app.Add') }}</label>
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-8">
                        ...
                        <input type="text" id="title" name="title" class="form-control" placeholder="輸入 {{ __('app.Title') }}" maxlength="100" value="{{ request()->input('title', old('title')) }}" required>
                    </div>
                    @if ($errors->has('title'))
                        <div class=" col-sm-2">
                            {{--                            <span class="text-danger">{{ __('app.Title') }} 不可為空</span>--}}
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-8">
                        ...
                        <input type="text" id="authorName" name="authorName" class="form-control" placeholder="輸入 {{ __('app.AuthorName') }}" maxlength="100" value="{{ request()->input('authorName', old('authorName')) }}" required>
                    </div>
                    @if ($errors->has('authorName'))
                        <div class=" col-sm-2">
                            {{--                            <span class="text-danger">{{ __('app.AuthorName') }} 不可為空</span>--}}
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group date col-sm-8" id="publishedAt" data-target-input="nearest">
                        ...
                        <input type="text" class="form-control datetimepicker-input" data-target="#publishedAt" data-toggle="datetimepicker" name="publishedAt" class="form-control" placeholder="輸入 {{ __('app.PublishedAt') }}" value="{{ request()->input('publishedAt', old('publishedAt')) }}">
                    </div>
                    @if ($errors->has('publishedAt'))
                        <div class=" col-sm-2">
                            {{--                            <span class="text-danger">{{ __('app.PublishedAt') }} 不可為空</span>--}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="checkbox" id="display" name="display" value="1" @if (old('display', '') == 1) checked @endif>
                    </div>
                </div>
                <div class="form-group row">
